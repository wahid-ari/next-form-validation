...
test('test Zod Object default valid value and click Submit', async ({ page }) => {
  await page.goto('/zod-object');
...
test('test Zod Object default invalid value and click Submit', async ({ page }) => {
  await page.goto('/zod-object');
  await expect(page).toHaveURL('/zod-object');
