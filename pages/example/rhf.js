...
export default function Home() {
  ...
  return (
    <div>
      <Head>
        <title>Example React Hook Form Page</title>
        <meta name="description" content="Example React Hook Form Page" />
      ...
      <main className="dark:bg-neutral-900 min-h-screen pb-8">
        ...
        <div className="sm:flex sm:flex-wrap min-h-screen max-w-5xl mx-auto">
          ...
          <div className="sm:w-4/5 px-4 mx-auto pt-4">
            <h1 className="dark:text-white text-2xl font-semibold">React Hook Form Page</h1>
            <div className="mt-4 mb-8">
              <Code name='pages/rhf' code={`import { useState } from "react";
  ...
  return (
    <main className="dark:bg-neutral-900 min-h-screen pb-8">
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <input {...register("name", { required: true, maxLength: 20 })} type="text" id="name" placeholder='Name' className={inputClassName} />
        ...
        <input {...register("username", { required: true, maxLength: 10, pattern: /^[A-Za-z0-9]+$/i })} type="text" id="username" placeholder='Username' className={inputClassName} />
        ...
        <input {...register("email", { required: true, pattern: /^[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,}$/i })} type="email" id="email" placeholder='Email' className={inputClassName} />
        ...
        <input {...register("password", { required: true, minLength: 8, pattern: /^[A-Za-z0-9]+$/i })} type="password" id="password" placeholder='Password' className={inputClassName} />
        ...
        <textarea {...register("bio", { required: true, minLength: 10 })} type="text" id="bio" placeholder='Bio' className={textareaClassName} />
        ...
        <input {...register("web", { required: true, pattern: /^https?:\/\/(?:www\.)?[-a-zA-Z0-9@:%._\+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b(?:[-a-zA-Z0-9()@:%_\+.~#?&\/=]*)$/i })} type="text" id="web" placeholder='Web' className={inputClassName} />
        ...
        <input {...register("rating", { required: true, min: 1, max: 10 })} type="number" id="rating" placeholder='Rating' className={inputClassName} />
        ...
        <input {...register("age", { required: true, min: 1, max: 50 })} type="number" id="age" placeholder='Age' className={inputClassName} />
        ...
        <input {...register("dob", { required: true })} type="date" id="dob" className={inputClassName + "cursor-pointer"} />
        ...
        <select {...register("fruit", { required: true })} className={selectClassName}>
