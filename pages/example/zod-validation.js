...
export default function Home() {
  ...
  return (
    <div>
      <Head>
        <title>Example Zod Validation</title>
        <meta name="description" content="Example Zod Validation" />
      ...
      <main className="dark:bg-neutral-900 min-h-screen pb-8">
        ...
        <div className="sm:flex sm:flex-wrap min-h-screen max-w-5xl mx-auto">
          ...
          <div className="sm:w-4/5 px-4 mx-auto pt-4">
            <h1 className="dark:text-white text-2xl font-semibold">Zod Validation</h1>
            <div className="mt-4 mb-8">
              <Code name='validations/zod' code={`import { z } from "zod";
